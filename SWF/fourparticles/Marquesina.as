package 
{
	...
	public class Marquesina extends MovieClip
	{
		...
		public function GetmarquesinaText()
		{
			return _cajaTexto.text;
		}

		public function SetmarquesinaText(cadena:String)
		{
			_texto = cadena;
			_cajaTexto.text = unescape(_texto);
			formatearTexto();
		...
		*/
		...
		private function formatearTexto():void
		{
			...
			_formatoTexto.font = "Verdana";
			_formatoTexto.size = _tamano;
			_cajaTexto.text = _texto;
